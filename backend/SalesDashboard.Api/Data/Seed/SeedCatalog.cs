...
internal static class SeedCatalog
{
    ...
    public static readonly string[] QuickRefundReasons =
    [
        "Отказ клиента в период возврата", "Ошибка в заказе", "Не подошла комплектация", "Нашли дешевле",
    ];

    public static readonly string[] WarrantyRefundReasons =
    [
        "Гарантийный случай: отказ подвеса", "Гарантийный случай: сбой GPS/RTK", "Гарантийный случай: деградация батарей",
        "Заводской брак, выявленный в эксплуатации",
    ];

    public static readonly string[] DisputedRefundReasons =
    [
        "Претензия по несоответствию ТЗ", "Спор о повреждении после эксплуатации", "Расторжение договора поставки",
    ];
}
